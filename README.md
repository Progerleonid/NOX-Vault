...
Maintainers create all installers by pushing a version tag matching `client/CMakeLists.txt`, for example `git tag v0.2.2 && git push origin v0.2.2`. The release workflow builds and tests each native binary before publishing it.
